...
**Cognix** - A better open-source AI chatbot for individuals and teams, inspired by ChatGPT, Claude, Grok, and Gemini.
...
- 💰 **[Become a sponsor](https://github.com/sponsors/priyx)** to support ongoing development
