...
export function AppSidebarMenus({ user }: { user?: BasicUser }) {
  ...
  const workspaceLinks = [
    { href: "/agents", label: "Agent Marketplace", icon: BotIcon },
    { href: "/agent/new", label: "Create Agent", icon: PlusIcon },
    { href: "/workspace/prompts", label: "Prompts", icon: MessageSquareQuoteIcon },
    { href: "/workspace/memories", label: "Memories", icon: BrainIcon },
    { href: "/workspace/bookmarks", label: "Bookmarks", icon: BookmarkIcon },
    { href: "/workspace/files", label: "Files", icon: FileArchiveIcon },
    { href: "/workspace/skills", label: "Skills", icon: WrenchIcon },
  ];
