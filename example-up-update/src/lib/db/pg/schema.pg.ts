...
// Cognix Desktop session backups (pushed from the desktop app, kept in the cloud in
// addition to the desktop's local store). Full transcript preserved as raw JSON in `parts`.
